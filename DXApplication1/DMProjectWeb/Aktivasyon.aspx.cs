...
{
    public partial class Aktivasyon : MasterDetailPage
    {
        MasterUserControl masterUC;
        DetailUserControl detailUC;
        public override string PageName { get { return "Aktivasyon"; } }
        ...
        protected void LoadUserControls()
        {
            ...
            this.masterUC = LoadControl(string.Format("~/UserControls/ViewControls/AktivasyonYonetici_{0}_Master.ascx", viewMode)) as MasterUserControl;
        ...
        EditFormUserControl GetEditForm(string name)
        {
            ...
            //if (name == "Evaluation")
            //    return AktivasyonEFaturaEditForm;
            return null;
        }
        public override void SaveEditFormChanges(string parameters)
        {
            //POPUP KULLANACAĞIN ZAMAN BUNU VE YUKARIDAKİ GetEditForm AÇMALISIN.
            MasterUC.SelectedItemID = 0;// AktivasyonEFaturaEditForm.SaveChanges(parameters);
        }

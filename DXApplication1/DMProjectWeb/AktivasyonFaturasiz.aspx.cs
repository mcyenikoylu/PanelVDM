...
{
    public partial class AktivasyonFaturasiz : MasterDetailPage
    {
        MasterUserControl masterUC;
        DetailUserControl detailUC;
        public override string PageName { get { return "AktivasyonFaturasiz"; } }
        ...
        protected void LoadUserControls()
        {
            ...
            this.masterUC = LoadControl(string.Format("~/UserControls/ViewControls/AktivasyonFaturasiz_{0}_Master.ascx", viewMode)) as MasterUserControl;
        ...
        EditFormUserControl GetEditForm(string name)
        {
            ...
            //    return TaskEditForm;
            if (name == "Evaluation")
                return AktivasyonFaturasizEditForm;
            return null;
        }
        public override void SaveEditFormChanges(string parameters)
        {
            ...
            MasterUC.SelectedItemID = AktivasyonFaturasizEditForm.SaveChanges(parameters);
        }

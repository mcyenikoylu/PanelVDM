<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="AktivasyonFaturasiz.aspx.cs" Inherits="DMProjectWeb.AktivasyonFaturasiz" %>
<%@ Register Src="~/UserControls/EditForms/AktivasyonFaturasizEditForm.ascx" TagPrefix="uc1" TagName="AktivasyonFaturasizEditForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div id="EditFormsContainer">
        <uc1:AktivasyonFaturasizEditForm runat="server" ID="AktivasyonFaturasizEditForm" />
    </div>
</asp:Content>

...
{
    public partial class SebekeIciGecis : MasterDetailPage
    {
        MasterUserControl masterUC;
        DetailUserControl detailUC;
        public override string PageName { get { return "AktivasyonSebekeIciGecis"; } }
        ...
        protected void LoadUserControls()
        {
            ...
            this.masterUC = LoadControl(string.Format("~/UserControls/ViewControls/AktivasyonSebekeIciGecis_{0}_Master.ascx", viewMode)) as MasterUserControl;
        ...
        EditFormUserControl GetEditForm(string name)
        {
            ...
            //    return TaskEditForm;
            if (name == "Evaluation")
                return AktivasyonSebekeIciGecisEditForm;
            return null;
        }
        public override void SaveEditFormChanges(string parameters)
        {
            ...
            MasterUC.SelectedItemID = AktivasyonSebekeIciGecisEditForm.SaveChanges(parameters);
        }

...
{
    public partial class AktivasyonVodafoneNet : MasterDetailPage
    {
        MasterUserControl masterUC;
        DetailUserControl detailUC;
        public override string PageName { get { return "AktivasyonVodafoneNet"; } }
        ...
        protected void LoadUserControls()
        {
            ...
            this.masterUC = LoadControl(string.Format("~/UserControls/ViewControls/AktivasyonVodafoneNet_{0}_Master.ascx", viewMode)) as MasterUserControl;
        ...
        EditFormUserControl GetEditForm(string name)
        {
            ...
            //    return TaskEditForm;
            if (name == "Evaluation")
                return AktivasyonVodafoneNetEditForm;
            return null;
        }
        public override void SaveEditFormChanges(string parameters)
        {
            ...
            MasterUC.SelectedItemID = AktivasyonVodafoneNetEditForm.SaveChanges(parameters);
        }

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="BayiTanimlari.aspx.cs" Inherits="DMProjectWeb.BayiTanimlari" %>

<%@ Register Src="~/UserControls/EditForms/BayiEditForm.ascx" TagPrefix="uc1" TagName="BayiEditForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div id="EditFormsContainer">
        <uc1:BayiEditForm runat="server" ID="BayiEditForm" />
    </div>
</asp:Content>

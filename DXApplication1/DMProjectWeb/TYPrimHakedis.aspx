<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="TYPrimHakedis.aspx.cs" Inherits="DMProjectWeb.TYPrimHakedis" %>

<%@ Register Src="~/UserControls/EditForms/DosyaYuklemeForm_PrimHakedis.ascx" TagPrefix="uc1" TagName="DosyaYuklemeForm_PrimHakedis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div id="EditFormsContainer">
        <uc1:DosyaYuklemeForm_PrimHakedis runat="server" id="DosyaYuklemeForm_PrimHakedis" />
    </div>
</asp:Content>

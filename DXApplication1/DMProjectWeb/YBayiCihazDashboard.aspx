<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="YBayiCihazDashboard.aspx.cs" Inherits="DMProjectWeb.YBayiCihazDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div id="MasterContainer" runat="server" class="dash">
        <dx:ASPxDashboardViewer ID="ASPxDashboard1" runat="server" ClientInstanceName="aSPxDashboard1" DashboardSource="~/App_Data/Dashboards/dashboard1.xml" Width="100%" >

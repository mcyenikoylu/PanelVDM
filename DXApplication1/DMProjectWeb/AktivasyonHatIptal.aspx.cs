...
{
    public partial class AktivasyonHatIptal : MasterDetailPage
    {
        MasterUserControl masterUC;
        DetailUserControl detailUC;
        public override string PageName { get { return "AktivasyonHatIptal"; } }
        ...
        {
            var viewMode = "GirdView";// DemoUtils.IsEmployeeGridViewMode ? "GridView" : "CardView";
            this.masterUC = LoadControl(string.Format("~/UserControls/ViewControls/AktivasyonHatIptal_{0}_Master.ascx", viewMode)) as MasterUserControl;
        ...
        EditFormUserControl GetEditForm(string name)
        {
            ...
            //    return TaskEditForm;
            if (name == "Evaluation")
                return AktivasyonHatIptalEditForm;
            return null;
        }
        public override void SaveEditFormChanges(string parameters)
        {
            ...
            MasterUC.SelectedItemID = AktivasyonHatIptalEditForm.SaveChanges(parameters);
        }

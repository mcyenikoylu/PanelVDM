<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AktivasyonEFaturaEditForm.ascx.cs" Inherits="DMProjectWeb.UserControls.EditForms.AktivasyonEFaturaEditForm" %>
<script type="text/javascript">
    ...
    function UploadControl_OnFilesUploadComplete3(e) {
        ...
        document.getElementById("someImageID1").src = imageData[5];
        document.getElementById("someImageID2").src = imageData[6];
    }
                    ...
                    <dx:ASPxFormLayout ID="EmployeeEditFormLayout" runat="server" AlignItemCaptionsInAllGroups="True">
                        ...
                        <Items>
                            ...
                            <dx:LayoutGroup ColCount="2" GroupBoxDecoration="HeadingLine" ShowCaption="True" Caption="HAT BİLGİLERİ">
                                <Items>
                                    <dx:LayoutItem Caption="E-Fatura Hat Numarası">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                       ...
                                       <dx:LayoutItem Caption="E-Fatura Tipi">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxComboBox ID="CmbEFaura" runat="server" Width="250px" NullText="Seçiniz">
                                                    <ValidationSettings ErrorDisplayMode="ImageWithTooltip">
                                                        <RequiredField IsRequired="True" ErrorText="Fatura tipi seçiniz." />
                                                    </ValidationSettings>
                                                </dx:ASPxComboBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxUploadControl ID="UcEvraklar" runat="server" ClientInstanceName="ucEvraklar" Width="400px" MaxLength="30"
                                                    ...
                                                    <ValidationSettings MaxFileSize="40000000" MaxFileSizeErrorText="40mb üzerinde dosya yükleyemezsiniz." MaxFileCount="7"
                                                        MaxFileCountErrorText="Sadece 7 adet dosya yükleyebilirsiniz." ShowErrors="true"
                            ...
                            <dx:LayoutGroup ColCount="1" GroupBoxDecoration="HeadingLine" ShowCaption="True" Caption="DİĞER EVRAKLAR">
                                <Items>
                                    ...
                                    <dx:LayoutItem Caption="6. Evrak Resmi">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <img id="someImageID1" width="650" height="850" />
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem Caption="7. Evrak Resmi">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DosyaYuklemeForm_HedefSatisDurumu.ascx.cs" Inherits="DMProjectWeb.UserControls.EditForms.DosyaYuklemeForm" %>

...
{
    public partial class AktivasyonEFaturaEditForm : EditFormUserControl
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            var tarife = db.S_Tip(12).ToList();
            if (tarife.Count > 0)
                foreach (var item in tarife)
                    CmbEFaura.Items.Add(item.TipAdi, item.ID);
        }
        ...
        public override int SaveChanges(string args)
        {
            ...
            if (callbackArgs[0] == "New")
            {
                ...
                var sonuc = db.I_Aktivasyon(Convert.ToInt32(bayiid), guid,
                    ...
                    false,
                    30, 
                    Convert.ToInt32(CmbEFaura.SelectedItem.Value)).ToList();

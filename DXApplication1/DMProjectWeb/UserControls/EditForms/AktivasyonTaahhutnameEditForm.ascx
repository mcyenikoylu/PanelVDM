<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AktivasyonTaahhutnameEditForm.ascx.cs" Inherits="DMProjectWeb.UserControls.EditForms.AktivasyonTaahhutnameEditForm" %>
<script type="text/javascript">
    ...
    function UploadControl_OnFilesUploadComplete3(e) {
        ...
        document.getElementById("someImageID9").src = imageData[5];
    }
...
<dx:ASPxPopupControl ID="PcAktFaturali" ClientInstanceName="pcAktFaturali" runat="server" HeaderText="Aktivasyon Taahütname"
    ...
    <ClientSideEvents EndCallback="DevAV.AktivasyonTaahhutnameEditForm_EndCallback" />
    <ContentCollection>
                    ...
                    <dx:ASPxFormLayout ID="EmployeeEditFormLayout" runat="server" AlignItemCaptionsInAllGroups="True">
                        ...
                        <Items>
                            ...
                            <dx:LayoutGroup ColCount="2" GroupBoxDecoration="HeadingLine" ShowCaption="True" Caption="HAT BİLGİLERİ">
                                <Items>
                                    <dx:LayoutItem Caption="Açılacak Hat Numarası">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                        ...
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxUploadControl ID="UcEvraklar" runat="server" ClientInstanceName="ucEvraklar" Width="400px" MaxLength="30"
                                                    ...
                                                    <ValidationSettings MaxFileSize="30000000" MaxFileSizeErrorText="30mb üzerinde dosya yükleyemezsiniz." MaxFileCount="6"
                                                        MaxFileCountErrorText="Sadece 6 adet dosya yükleyebilirsiniz." ShowErrors="true"
                                                        AllowedFileExtensions=".jpg,.png,.jpeg">
                                                    </ValidationSettings>
                                                    <ClientSideEvents
                                                        FilesUploadStart="function(s, e) { UploadControl_OnFileUploadStart(); }"
                            ...
                            <dx:LayoutGroup ColCount="1" GroupBoxDecoration="HeadingLine" ShowCaption="True" Caption="DİĞER EVRAKLAR">
                                <Items>
                                    ...
                                    <dx:LayoutItem Caption="6. Evrak Resmi">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <img id="someImageID9" width="650" height="850" />
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                </Items>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxButton ID="btnOk" runat="server" AutoPostBack="false" Text="Kaydet" Width="50">
                        <ClientSideEvents Click="DevAV.AktivasyonTaahhutnameSaveButton_Click" />
                    </dx:ASPxButton>
                </td>
                <td style="width: 50px"></td>
                <td style="padding-left: 10px;">
                    <dx:ASPxButton ID="btnCansel" runat="server" AutoPostBack="false" Text="Vazgeç" Width="50">
                        <ClientSideEvents Click="DevAV.AktivasyonTaahhutnameCancelButton_Click" />
                    </dx:ASPxButton>
                </td>
            </tr>
        </table>

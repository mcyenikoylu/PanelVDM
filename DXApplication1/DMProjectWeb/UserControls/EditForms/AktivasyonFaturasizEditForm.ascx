<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AktivasyonFaturasizEditForm.ascx.cs" Inherits="DMProjectWeb.UserControls.EditForms.AktivasyonFaturasizEditForm" %>
...
<dx:ASPxPopupControl ID="PcAktFaturali" ClientInstanceName="pcAktFaturali" runat="server" HeaderText="Aktivasyon Faturasız"
    ...
    <ClientSideEvents EndCallback="DevAV.AktivasyonFaturasizEditForm_EndCallback" />
    <ContentCollection>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxButton ID="btnOk" runat="server" AutoPostBack="false" Text="Kaydet" Width="50">
                        <ClientSideEvents Click="DevAV.AktivasyonFaturasizSaveButton_Click" />
                    </dx:ASPxButton>
                </td>
                <td style="width: 50px"></td>
                <td style="padding-left: 10px;">
                    <dx:ASPxButton ID="btnCansel" runat="server" AutoPostBack="false" Text="Vazgeç" Width="50">
                        <ClientSideEvents Click="DevAV.AktivasyonFaturasizCancelButton_Click" />
                    </dx:ASPxButton>
                </td>
            </tr>
        </table>

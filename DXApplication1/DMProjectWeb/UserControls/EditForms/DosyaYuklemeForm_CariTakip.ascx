<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DosyaYuklemeForm_CariTakip.ascx.cs" Inherits="DMProjectWeb.UserControls.EditForms.DosyaYuklemeForm_CariTakip" %>

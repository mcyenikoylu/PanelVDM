<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DosyaYuklemeForm_PrimHakedis.ascx.cs" Inherits="DMProjectWeb.UserControls.EditForms.DosyaYuklemeForm_PrimHakedis" %>

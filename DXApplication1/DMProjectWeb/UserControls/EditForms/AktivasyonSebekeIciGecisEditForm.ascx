<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AktivasyonSebekeIciGecisEditForm.ascx.cs" Inherits="DMProjectWeb.UserControls.EditForms.AktivasyonSebekeIciGecisEditForm" %>
                    ...
                    <dx:ASPxFormLayout ID="EmployeeEditFormLayout" runat="server" AlignItemCaptionsInAllGroups="True">
                        ...
                        <Items>
                            ...
                            <dx:LayoutGroup ColCount="1" GroupBoxDecoration="HeadingLine" ShowCaption="True" Caption="EVRAKLAR">
                                <Items>
                                    <dx:LayoutItem Caption="Şebeke Formu">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                    ...
                                    <dx:LayoutItem Caption="Sabit Fatura">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <dx:ASPxUploadControl ID="UcSabitFatura" runat="server" ClientInstanceName="ucSabitFatura" Width="400px" MaxLength="30"
                                                    NullText="Evrak seçmek için buraya tıklayın..." UploadMode="Advanced" AutoStartUpload="true" ShowProgressPanel="true"
                                                    OnFilesUploadComplete="UcSabitFatura_FilesUploadComplete">
                                                    <AdvancedModeSettings EnableMultiSelect="false" EnableDragAndDrop="True" EnableFileList="false" />
                                                    <ValidationSettings MaxFileSize="5000000" MaxFileSizeErrorText="5mb üzerinde dosya yükleyemezsiniz." MaxFileCount="1"
                                                        MaxFileCountErrorText="Sadece 1 adet dosya yükleyebilirsiniz." ShowErrors="true"
                                                        AllowedFileExtensions=".jpg,.png,.jpeg">
                                                    ...
                                                    <ClientSideEvents
                                                        FilesUploadStart="function(s, e) { UploadControl_OnFileUploadStart(); }"
                                                        FilesUploadComplete="function(s, e) { UploadControl_OnFilesUploadComplete4(e); }"
                                                        UploadingProgressChanged="function(s, e) { UploadControl_OnUploadingProgressChanged(e); }" />
                                                </dx:ASPxUploadControl>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                            ...
                            <dx:LayoutGroup ColCount="1" GroupBoxDecoration="HeadingLine" ShowCaption="True" Caption="ŞEBEKE FORMU">
                                <Items>
                            ...
                            <dx:LayoutGroup ColCount="1" GroupBoxDecoration="HeadingLine" ShowCaption="True" Caption="SABİT FATURA">
                                <Items>
                                    <dx:LayoutItem Caption="Evrak Resmi">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer runat="server">
                                                <img id="someImageID8" width="650" height="850" />
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                </Items>

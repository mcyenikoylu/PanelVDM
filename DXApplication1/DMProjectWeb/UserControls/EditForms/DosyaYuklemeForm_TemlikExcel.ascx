<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DosyaYuklemeForm_TemlikExcel.ascx.cs" Inherits="DMProjectWeb.UserControls.EditForms.DosyaYuklemeForm_TemlikExcel" %>
            ...
            <dx:ASPxFormLayout ID="EmployeeEditFormLayout" runat="server" AlignItemCaptionsInAllGroups="True">
                <Items>
                    <dx:TabbedLayoutGroup>
                        <Items>
                            <dx:LayoutGroup Caption="Yeni Ekle">
                                <Items>
                            ...
                            <dx:LayoutGroup Caption="Kayıtları Güncelle">
                                <Items>
                                    <dx:LayoutItem Caption="Eski Kayıtlar Silinecek">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer3" runat="server">
                                                <dx:ASPxCheckBox ID="ChkKayitlariGuncelle" runat="server" TextAlign="Right" Text="Yeni yüklenecek olan dosyadaki kayıtlar eklenecek."></dx:ASPxCheckBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem Caption="Silinecek Tarih">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer4" runat="server">
                                                <div style="float: left;">
                                                    <div style="width: 50%; float: left;">
                                                        <dx:ASPxComboBox ID="CmbAy" runat="server" Caption="Ay" ClientInstanceName="cmbAy">
                                                            <Items>
                                                    ...
                                                    <div style="width: 47%; float: left; margin-left:3px;">
                                                        <dx:ASPxComboBox ID="CmbYil" runat="server" Caption="Yıl" ClientInstanceName="cmbYil">
                                                            <Items>
                                    ...
                                    <dx:LayoutItem Caption="Dosya Yolu">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer5" runat="server">
                                                <dx:ASPxUploadControl ID="UploadControlGuncelle" runat="server" ClientInstanceName="uploadControlGuncelle" Width="400px" MaxLength="30"
                                                    NullText="Dosya seçmek için buraya tıklayın..." UploadMode="Advanced" AutoStartUpload="false" FileUploadMode="OnPageLoad"
                                                    OnFilesUploadComplete="UploadControlGuncelle_FilesUploadComplete">
                                                    <AdvancedModeSettings EnableMultiSelect="false" EnableDragAndDrop="True" />
                                                    <ValidationSettings MaxFileSize="10000000" MaxFileSizeErrorText="10mb üzerinde dosya yükleyemezsiniz." MaxFileCount="1"
                                                        MaxFileCountErrorText="Sadece tek bir dosya yükleyebilirsiniz." ShowErrors="true" AllowedFileExtensions=".xls,.xlsx,.csv">
                                                    </ValidationSettings>
                                    ...
                                    <dx:LayoutItem ShowCaption="False">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer6" runat="server">
                                                <div class="buttonsContainer">
                                                    <dx:ASPxButton ID="ASPxButton1" runat="server" AutoPostBack="false" Text="Yükle" Width="100px">
                                                        <ClientSideEvents Click="function(s, e) { 
                                                            uploadControlGuncelle.Upload(); }" />
                                                    </dx:ASPxButton>
                                                    <dx:ASPxButton ID="ASPxButton2" runat="server" AutoPostBack="False" UseSubmitBehavior="False" Text="Vazgeç" Width="100px">
                                                        <ClientSideEvents Click="DevAV.DosyaYuklemeVazgecButton_Click" />
                                                    </dx:ASPxButton>
                                                </div>
                                            </dx:LayoutItemNestedControlContainer>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AktivasyonVodafoneNetEditForm.ascx.cs" Inherits="DMProjectWeb.UserControls.EditForms.AktivasyonVodafoneNetEditForm" %>
...
<dx:ASPxPopupControl ID="PcAktFaturali" ClientInstanceName="pcAktFaturali" runat="server" HeaderText="Aktivasyon Şebeke İçi Geçiş"
    ...
    <ClientSideEvents EndCallback="DevAV.AktivasyonVodafoneNetEditForm_EndCallback" />
    <ContentCollection>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxButton ID="btnOk" runat="server" AutoPostBack="false" Text="Kaydet" Width="50">
                        <ClientSideEvents Click="DevAV.AktivasyonVodafoneNetSaveButton_Click" />
                    </dx:ASPxButton>
                </td>
                <td style="width: 50px"></td>
                <td style="padding-left: 10px;">
                    <dx:ASPxButton ID="btnCansel" runat="server" AutoPostBack="false" Text="Vazgeç" Width="50">
                        <ClientSideEvents Click="DevAV.AktivasyonVodafoneNetCancelButton_Click" />
                    </dx:ASPxButton>
                </td>
            </tr>
        </table>

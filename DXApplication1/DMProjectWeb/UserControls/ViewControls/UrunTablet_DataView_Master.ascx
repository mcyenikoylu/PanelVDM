<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UrunTablet_DataView_Master.ascx.cs" Inherits="DMProjectWeb.UserControls.ViewControls.UrunTablet_DataView_Master" %>

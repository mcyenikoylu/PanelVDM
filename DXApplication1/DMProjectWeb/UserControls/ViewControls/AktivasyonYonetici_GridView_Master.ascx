<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AktivasyonYonetici_GridView_Master.ascx.cs" Inherits="DMProjectWeb.UserControls.ViewControls.AktivasyonYonetici_GridView_Master" %>
<dx:ASPxGridView ID="EmployeesGrid" runat="server"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="EfaturaTipi" Caption="E-Fatura Tipi" VisibleIndex="0" Width="8%"/>
    </Columns>
    ...
    <Settings VerticalScrollBarMode="Auto" VerticalScrollableHeight="400" HorizontalScrollBarMode="Visible" ShowGroupPanel="true" />

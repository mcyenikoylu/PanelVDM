<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AktivasyonTaahhutname_GridView_Master.ascx.cs" Inherits="DMProjectWeb.UserControls.ViewControls.AktivasyonTaahhutname_GridView_Master" %>
<dx:ASPxGridView ID="EmployeesGrid" runat="server"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="TarifeAdi" Caption="Tarife Adı" VisibleIndex="0" Width="52%" />
    </Columns>

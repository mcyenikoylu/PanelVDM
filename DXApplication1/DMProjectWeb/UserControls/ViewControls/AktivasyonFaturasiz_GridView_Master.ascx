<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AktivasyonFaturasiz_GridView_Master.ascx.cs" Inherits="DMProjectWeb.UserControls.ViewControls.AktivasyonFaturasiz_GridView_Master" %>

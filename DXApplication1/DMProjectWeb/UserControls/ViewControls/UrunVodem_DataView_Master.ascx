<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UrunVodem_DataView_Master.ascx.cs" Inherits="DMProjectWeb.UserControls.ViewControls.UrunVodem_DataView_Master" %>

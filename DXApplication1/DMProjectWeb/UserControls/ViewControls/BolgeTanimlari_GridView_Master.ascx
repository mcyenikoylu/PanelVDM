<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BolgeTanimlari_GridView_Master.ascx.cs" Inherits="DMProjectWeb.UserControls.ViewControls.BolgeTanimlari_GridView_Master" %>
                ...
                <tr>
                    <td>
                        ...
                        <dx:ASPxGridViewTemplateReplacement ID="TxtAdiSoyadi" runat="server" 
                            ReplacementType="EditFormCellEditor" ColumnID="Adi" Width="400px">

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AktivasyonEFatura_GridView_Master.ascx.cs" Inherits="DMProjectWeb.UserControls.ViewControls.AktivasyonEFatura_GridView_Master" %>
<dx:ASPxGridView ID="EmployeesGrid" runat="server"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="Aciklama" Caption="Açıklama" VisibleIndex="0" Width="41%" />

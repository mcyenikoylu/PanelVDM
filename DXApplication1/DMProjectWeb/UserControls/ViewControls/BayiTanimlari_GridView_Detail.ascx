<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BayiTanimlari_GridView_Detail.ascx.cs" Inherits="DMProjectWeb.UserControls.ViewControls.BayiTanimlari_GridView_Detail" %>

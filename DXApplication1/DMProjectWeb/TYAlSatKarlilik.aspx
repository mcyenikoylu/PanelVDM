<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="TYAlSatKarlilik.aspx.cs" Inherits="DMProjectWeb.TYAlSatKarlilik" %>

<%@ Register Src="~/UserControls/EditForms/DosyaYuklemeForm_AlSatKarlilik.ascx" TagPrefix="uc1" TagName="DosyaYuklemeForm_AlSatKarlilik" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div id="EditFormsContainer">
        <uc1:DosyaYuklemeForm_AlSatKarlilik runat="server" id="DosyaYuklemeForm_AlSatKarlilik" />
    </div>
</asp:Content>

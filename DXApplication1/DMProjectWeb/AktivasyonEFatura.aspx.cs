...
{
    public partial class AktivasyonEFatura : MasterDetailPage
    {
        MasterUserControl masterUC;
        DetailUserControl detailUC;
        public override string PageName { get { return "AktivasyonEFatura"; } }
        ...
        protected void LoadUserControls()
        {
            ...
            this.masterUC = LoadControl(string.Format("~/UserControls/ViewControls/AktivasyonEFatura_{0}_Master.ascx", viewMode)) as MasterUserControl;
        ...
        public override void SaveEditFormChanges(string parameters)
        {
            ...
            MasterUC.SelectedItemID = AktivasyonEFaturaEditForm.SaveChanges(parameters);
        }
